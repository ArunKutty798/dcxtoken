...
t.me/DogeDealer . DogeDealerCoin.com

THIS IS A TEST CONTRACT & NOT THE FINAL VERSION. 1000 BNB PRESALE IS ON AUGUST 17TH @ 17:00 UTC!
...
contract DogeDealer is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if (amount == 0) {
            ...
            uint256 originalAmountBeforeFees = amount;
    ...
    */
    ...
    function swapAndSendDividendsAndMarketingFunds(uint256 dividends, uint256 marketing) private {
        ...
        swapTokensForEth(dividends);
        countBNBRewardsFee -= dividends;
        uint256 BNBRewardsFeeBNB = address(this).balance;
        if(dividends <= 0){
            BNBRewardsFeeBNB = 0;
        }
        ...
        uint256 devFeesBNB = address(this).balance;
        if(marketing <= 0){
            devFeesBNB = 0;
        }
